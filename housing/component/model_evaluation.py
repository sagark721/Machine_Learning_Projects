...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            if model is None:
                logging.info(f"Not found any aexisting model, hence accepting Trained model")
            ...
            if metric_info_artifact.index_number == 1:
                ...
                logging.info(f"Trained model is not better than existing model hence not accepting the trained model.")
