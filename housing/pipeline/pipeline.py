...
from housing.component.model_trainer import Model_Trainer
import os,sys
from housing.constant import *
import uuid
import pandas as pd

Experiment = namedtuple("Experiment",["experiment_id","initialization_timestamp","artifact_timestamp","running_status","start_time",
                                        "stop_time","execution_time","message","experiment_file_path","accuracy","is_model_accepted"]
                                        )
...
class Pipeline(Thread):
        ...
        def run_pipeline(self):
            try:
                ...
                model_evaluation_artifact = self.start_model_evaluation(data_ingestion_artifact=data_ingestion_artifact,data_validation_artifact=data_validation_artifact,
                                                                        model_trainer_artifact=model_trainer_artifact)
